                          ...
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                <div class="mt-4">
                                    ...
                                    <x-text-input  class="block mt-1 w-full ayoub" type="text" name="titre" :value="old('titre')"  />
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <div class="mt-4">
                                    ...
                                    <x-text-input  class="block mt-1 w-full" type="text" name="emplacement" :value="old('emplacement')"  />
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-12">
                                <div class="mt-4">
                                    ...
                                    <x-text-input  class="block mt-1 w-full" type="text" name="competence" :value="old('competence')"  />
